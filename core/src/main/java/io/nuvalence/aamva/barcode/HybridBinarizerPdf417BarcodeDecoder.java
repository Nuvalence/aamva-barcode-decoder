...
@Slf4j
public class HybridBinarizerPdf417BarcodeDecoder implements Pdf417BarcodeDecoder {
    ...
    public Barcode findPdf417BarcodeFromImage(BufferedImage image) {
        ...
        try {
            ...
            log.warn("Failed to find PDF417 barcode using hybrid binarizer decoder", re);
            return null;
        }
    }
